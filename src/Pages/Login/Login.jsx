...
const Login = () => {
  ...
  return (
    <div>
      <div>
        <h2 className="text-5xl my-10 text-center font-bold mt-[50px] text-white">
          Please Login
        </h2>
        <div className="md:w-[500px] w-[400px] mx-auto h-[400px] bg-white border border-black mb-9 p-8 ">
